...
" command! Tetris normal ,te
"=======================================================
"->FUNCTIONS:
"=======================================================
"
"=======================================================
"-> [plugin] AutoCompPop plugin settings:
"=======================================================
" disable it for now
...
"=======================================================
"-> [PLUGIN] Pydoc plugin settings:
"=======================================================
let g:pydoc_cmd = "c:/Python27/Lib/pydoc.py"

"=======================================================
"-> [PLUGIN] Pydiction settings:
"=======================================================

" location of 'complete-dict' file
...
"=======================================================
if has('win32')
    let Tlist_Ctags_Cmd =  $MYVIMFILES . '\utils\ctags58\ctags.exe'
endif
let g:ctags_status_line=1       "dispaly fuction name in status bar
